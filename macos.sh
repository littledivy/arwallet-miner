# Based on https://github.com/useverto/trading-post/blob/master/install/mac.sh
...
if [ $# -eq 0 ]; then
  release_uri="https://github.com/littledivy/arwallet-miner/releases/latest/download/arwallet-miner-x86_64-apple-darwin.zip"
else
  release_uri="https://github.com/littledivy/arwallet-miner/releases/download/${1}/arwallet-miner-x86_64-apple-darwin.zip"
fi
